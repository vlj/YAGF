...
struct WrapperPipelineState *createObjectShader()
{
  ...
  psodesc.BlendState = CD3D12_BLEND_DESC(D3D12_DEFAULT);
  result->D3DValue.pipelineStateObject = PipelineStateObject<VertexLayout<irr::video::S3DVertex2TCoords>>::get(psodesc, L"Debug\\object_pass_vtx.cso", L"Debug\\object_pass_pix.cso");
  return result;
}
#endif
