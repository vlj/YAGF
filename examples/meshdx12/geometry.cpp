...
object::object(device_t dev, const aiScene* model, command_list_t upload_cmd_list, descriptor_storage_t heap, vulkan_wrapper::pipeline_descriptor_set* object_set, vulkan_wrapper::pipeline_descriptor_set* model_set)
{
...
void object::fill_draw_command(device_t dev, command_list_t current_cmd_list, pipeline_layout_t object_sig)
{
#ifdef D3D12
...
void object::update_constant_buffers(device_t dev)
{
