...
constexpr auto sunlight_layout = pipeline_layout_description(
	descriptor_set({ range_of_descriptors(RESOURCE_VIEW::INPUT_ATTACHMENT, 0, 1), range_of_descriptors(RESOURCE_VIEW::INPUT_ATTACHMENT, 1, 1), range_of_descriptors(RESOURCE_VIEW::INPUT_ATTACHMENT, 2, 1), range_of_descriptors(RESOURCE_VIEW::CONSTANTS_BUFFER, 3, 1), range_of_descriptors(RESOURCE_VIEW::SAMPLER, 4, 1) }, shader_stage::fragment_shader)
);
