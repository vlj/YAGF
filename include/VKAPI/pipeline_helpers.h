...
constexpr VkPipelineRasterizationStateCreateInfo get_pipeline_rasterization_state_create_info(const graphic_pipeline_state_description desc)
{
...
constexpr VkPipelineMultisampleStateCreateInfo get_pipeline_multisample_state_create_info(const graphic_pipeline_state_description desc)
{
...
constexpr VkPipelineDepthStencilStateCreateInfo get_pipeline_depth_stencil_state_create_info(const graphic_pipeline_state_description desc)
{
...
constexpr VkPipelineInputAssemblyStateCreateInfo get_pipeline_input_assembly_state_info(const graphic_pipeline_state_description desc)
{
