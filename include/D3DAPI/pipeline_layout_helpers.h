...
inline D3D12_DESCRIPTOR_RANGE_TYPE get_range_type(RESOURCE_VIEW type)
{
	...
	case RESOURCE_VIEW::TEXEL_BUFFER: return D3D12_DESCRIPTOR_RANGE_TYPE_SRV;
	case RESOURCE_VIEW::SHADER_RESOURCE: return D3D12_DESCRIPTOR_RANGE_TYPE_SRV;
	case RESOURCE_VIEW::UAV_BUFFER: return D3D12_DESCRIPTOR_RANGE_TYPE_UAV;
	case RESOURCE_VIEW::UAV_IMAGE: return D3D12_DESCRIPTOR_RANGE_TYPE_UAV;
